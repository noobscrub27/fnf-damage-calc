...
function getTierRanking(tier) {
    var _a;
    const isNintendo = tier.startsWith('vgc') || tier.startsWith('battlestadium') || tier.startsWith('battlespot');
    return (_a = TIER_RANKINGS[isNintendo ? 'nintendo' : tier]) !== null && _a !== void 0 ? _a : 100;
}
