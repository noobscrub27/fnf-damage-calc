...
const ADV = [
  ...
  'Slow Digestion',
  'Toxcceleration',
  // FnF changes start here (Gen undecided)
  'Arachnid\'s Grace',
  'Bone Master',
  'Cunning Blade',
  'Draconize',
