...
$(".ability").bind("keyup change", function () {
	...
	var TOGGLE_ABILITIES = ['Flash Fire', 'Intimidate', 'Minus', 'Plus', 'Slow Start', 'Unburden', 'Stakeout', 'Inflate', 'Download', 'Search Engine', 'Luminesce', 'Teraform Zero'];
...
function createField() {
	...
	var isMiracleEye = [$("#miracleEyeL").prop("checked"), $("#miracleEyeR").prop("checked")];
	...
	var isTeamSpirit = [$("#teamSpiritL").prop("checked"), $("#teamSpiritR").prop("checked")];
	...
	var createSide = function (i) {
		return new calc.Side({
			...
			isProtected: isProtected[i], isSeeded: isSeeded[i], isForesight: isForesight[i], isMiracleEye: isMiracleEye[i],
			isTailwind: isTailwind[i], isHelpingHand: isHelpingHand[i], isFlowerGift: isFlowerGift[i], isFriendGuard: isFriendGuard[i],
			isAuroraVeil: isAuroraVeil[i], isBattery: isBattery[i], isTeamSpirit: isTeamSpirit[i], isPowerSpot: isPowerSpot[i], isSwitching: isSwitchingOut[i] ? 'out' : undefined
		});
	};
...
function clearField() {
	...
	$("#miracleEyeL").prop("checked", false);
	$("#miracleEyeR").prop("checked", false);
