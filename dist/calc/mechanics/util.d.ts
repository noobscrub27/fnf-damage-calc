...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean, isBoneMaster?: boolean): number;
...
export declare function checkSearchEngine(source: Pokemon, target: Pokemon): void;
