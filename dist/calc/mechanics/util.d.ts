...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, isGhostRevealed?: boolean, isDarkRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean, isBoneMaster?: boolean): import("../data/interface").TypeEffectiveness;
