...
var GSC_PATCH = {
    ...
    Goldeen: { bs: { hp: 63, at: 77, sa: 45, sd: 65 } },
    Golduck: {
        types: ['Water', 'Psychic'],
    ...
    Seaking: { bs: { hp: 83, at: 97, df: 80, sa: 60, sd: 90, sp: 84 } },
...
var SM_PATCH = {
    ...
    Despotide: {
        types: ['Water', 'Dragon'],
        bs: { hp: 93, at: 127, df: 90, sa: 70, sd: 104, sp: 102 },
    ...
    Portamora: {
        types: ['Water'],
        bs: { hp: 95, at: 90, df: 135, sa: 90, sd: 125, sp: 55 },
        abilities: { 0: 'Carrier' },
        weightkg: 310
    },
    'Longeon-Spaghetti': {
