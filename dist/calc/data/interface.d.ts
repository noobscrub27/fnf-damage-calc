...
export type Terrain = 'Electric' | 'Grassy' | 'Berserk' | 'Psychic' | 'Misty';
export type Weather = 'Sand' | 'Sun' | 'Rain' | 'Hail' | 'Snow' | 'Miasma' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds' | 'Shadow Sky';
...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' | 'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | 'Shadow' | 'Stellar' | '???';
